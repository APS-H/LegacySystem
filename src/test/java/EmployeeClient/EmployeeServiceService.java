 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceService", targetNamespace = "http://service.legacy.apsh.com/", wsdlLocation = "http://localhost:8081/Employer?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICESERVICE_QNAME = new QName("http://service.legacy.apsh.com/", "EmployeeServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Employer?wsdl");
    ...
    public EmployeeService getEmployeeServicePort(){
        return super.getPort(new QName("http://service.legacy.apsh.com/", "EmployeeServicePort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.legacy.apsh.com/", "EmployeeServicePort"), EmployeeService.class, features);
    }
